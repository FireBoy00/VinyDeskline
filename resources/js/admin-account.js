...
document.addEventListener("DOMContentLoaded", function () {
    ...
    userInfoForm.addEventListener("submit", async function (e) {
        ...
        try {
            ...
            saveInfoBtnIcon.textContent = "check_circle";
            alert(
                `An error occurred while updating your information: ${error.message}. Please try again. If the problem persists, contact support.`
            );
        }
    });
    ...
    const saveSettingsBtnText =
        saveSettingsBtn.querySelector("span:first-child");
    const saveSettingsBtnIcon = saveSettingsBtn.querySelector(
    ...
    userSettingsForm.addEventListener("submit", async function (e) {
        ...
        try {
            ...
            if (response.ok) {
                ...
                alert(
                    result.message ||
                        "Unable to update your settings. Please check your input and try again. If the problem persists, contact support."
                );
            }
        } catch (error) {
            console.error("Error:", error);
            ...
            saveSettingsBtnIcon.textContent = "check_circle";
            alert(
                `An error occurred while updating your settings: ${error.message}. Please try again. If the problem persists, contact support.`
            );
        }
    });
