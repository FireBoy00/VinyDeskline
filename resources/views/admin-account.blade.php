        ...
        <section class="section account-section">
            ...
            <div class="account-layout">
                ...
                <div class="account-column account-user-info">
                    ...
                    <form class="account-form" id="user-info-form"
                        data-update-url="{{ route('admin.account.update-info') }}">
                        @csrf
                        <div class="form-row">
                ...
                <div class="account-column account-user-settings">
                    ...
                    <form class="account-form" id="user-settings-form"
                        data-update-url="{{ route('admin.account.update-settings') }}">
                        @csrf
                        <div class="form-row">
                        ...
                        <div class="form-actions">
                            ...
                            <button type="button" class="danger-btn reset-account-btn" id="reset-btn"
                                data-reset-url="{{ route('admin.account.reset-settings') }}">
