            ...
            <section class="card about-card">
                ...
                <div class="about-section">
                    ...
                    <ul>
                        ...
                        <li><strong>Ergonomic assistance</strong> – storing user height profiles and suggesting when to sit or stand.</li>
                        <li><strong>Uniform desk arrangement</strong> – aligning multiple desks to the same height when needed.</li>
                    </ul>
                </div>
                ...
                <div class="about-section">
                    ...
                    <ul>
                        ...
                        <li><strong>Backend:</strong> Laravel (PHP) web application exposing routes for users and admins.</li>
                        <li><strong>Database:</strong> SQLite/MySQL with Eloquent ORM for users, desks, and usage data.</li>
                        <li><strong>Embedded & tools:</strong> Pico-based desk controller, GitHub, DevDb, Docker, Figma, Discord.</li>
                    </ul>
                </div>
                ...
                <div class="about-section">
                    ...
                    <p>
                        ...
                        <strong>SE3-PRO-3: Semester Project 3 – Distributed Software Systems with Embedded Elements</strong>.
