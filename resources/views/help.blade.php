            ...
            <section class="card about-card">
                ...
                <div class="about-section">
                    ...
                    <ul>
                        ...
                        <li><strong>Personalization:</strong> If prompted, enter your height so the system can suggest ergonomic sit/stand heights.</li>
                        <li><strong>Skip personalization:</strong> You can skip it, but recommendations will be less accurate.</li>
                    </ul>
                </div>
                ...
                <div class="about-section">
                    ...
                    <ul>
                        <li><strong>Daily Briefing:</strong> Short messages and updates about your desk usage or office information.</li>
                        <li><strong>Temperature carousel:</strong> Browse sensor readings (e.g. temperature) using the left/right arrows.</li>
                        <li><strong>Your Table:</strong> Visual representation of your desk.</li>
                        <li><strong>Optimal Positions:</strong> Suggested standing and sitting heights based on your profile.</li>
                        <li><strong>Custom Positions:</strong> Create and save your own named height presets.</li>
                        <li><strong>Your Statistics:</strong> Graph showing how your desk has been used (sitting, standing, cleaning, lowered).</li>
                ...
                <div class="about-section">
                    ...
                    <ul>
                        <li><strong>Cleaning schedule:</strong> At configured times, desks can be raised to a cleaning height to support cleaning staff.</li>
                        <li><strong>Uniform schedule:</strong> Admins can align multiple desks to the same height for specific periods.</li>
                        <li><strong>Manual control:</strong> You can still use the physical desk controls; the system will update its state based on the controller.</li>
                    </ul>
                </div>
                ...
                <div class="about-section">
                    ...
                    <ul>
                        <li><strong>Admin Dashboard:</strong> Overview of total, occupied, available, raised, lowered, and faulty desks.</li>
                ...
                <div class="about-section">
                    ...
                    <ul>
                        <li>
                            ...
                            Only users with admin permissions can access admin pages. Regular users will see a 403 (Forbidden) page.
                        </li>
                        <li>
                            <strong>Why do I keep seeing the personalization page?</strong><br>
                            Your account is marked as needing personalization. Complete the form once or choose “Skip” to go directly to the home page.
                        </li>
                        <li>
                            <strong>My desk height or status looks wrong — what should I do?</strong><br>
                            Ensure the desk controller is powered and connected. If it still looks incorrect, contact an administrator.
                        </li>
                    </ul>
                </div>
