                    ...
                    <div class="form-row">
                        ...
                        <div class="input-group">
                            ...
                            <div class="time-range-inputs">
                                <input type="text" class="schedule-input" name="start_time" id="uniformStart"
                                    aria-label="Start time" placeholder="Start Time" required>
                                <span style="margin: 0 8px;">-</span>
                                <input type="text" class="schedule-input" name="end_time" id="uniformEnd"
                                    aria-label="End time" placeholder="End Time" required>
                            </div>
                        </div>
                        <div class="input-group">
                            <label class="input-label" for="uniform-height-range">Height</label>
                            <div class="height-inputs-container">
                                <div class="height-input-with-unit">
                                    <input type="number" class="schedule-input height-input" id="uniform-height"
                                        value="680" min="680" max="1320" step="10" required>
                                    <span class="height-unit-label">mm</span>
                                </div>
                                <div class="height-input-with-unit">
                                    <input type="number" class="schedule-input height-input-cm"
                                        id="uniform-height-cm-input" value="68.0" step="0.1" disabled>
                                    <span class="height-unit-label">cm</span>
                                </div>
                            </div>
                        </div>
                        <div id="uniformDateContainer" class="input-group" style="display: none;">
                            <input type="text" id="uniformDate" name="uniform_dates" class="schedule-input"
                    ...
                    @foreach ($uniformSchedules as $schedule)
                        <div class="current-schedule" data-id="{{ $schedule->id }}">
                            <div class="current-schedule-info">
                                ...
                                <span class="schedule-time">{{ $schedule->start_time }} -
                ...
                <form class="schedule-form" id="cleaningForm">
                    <div class="form-row">
                        <div class="input-group">
                            ...
                            <input type="text" class="schedule-input" id="cleaning-title"
                                placeholder="Enter title" required>
                        </div>
                        <div class="input-group">
                            <label class="input-label" for="uniform-time-range">Time Range</label>
                            <div class="time-range-inputs">
                                <input type="text" class="schedule-input" id="cleaningStart" name="start_time"
                                    aria-label="Start time" placeholder="Start Time" required>
                                <span style="margin: 0 8px;">-</span>
                                <input type="text" class="schedule-input" name="end_time" id="cleaningEnd"
                                    aria-label="End time" placeholder="End Time" required>
                            </div>
                        </div>
                        <div class="input-group">
                            ...
                            <div class="height-inputs-container">
                                <div class="height-input-with-unit">
                                    <input type="number" class="schedule-input height-input" id="cleaning-height"
                                        value="1320" min="680" max="1320" step="10" required>
                                    <span class="height-unit-label">mm</span>
                                </div>
                                <div class="height-input-with-unit">
                                    <input type="number" class="schedule-input height-input-cm"
                                        id="cleaning-height-cm-input" value="132.0" step="0.1" disabled>
                                    <span class="height-unit-label">cm</span>
                                </div>
                            </div>
                        </div>
                        <div id="cleaningDateContainer" style="display: none;">
                            <input type="text" id="cleaningDate" name="cleaning_dates" class="schedule-input"
                                placeholder="Select date">
                        </div>
                    </div>
